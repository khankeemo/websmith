...
const styles: Record<string, any> = {
  ...
  kanbanColumn: { background: "#F9FAFB", borderRadius: "16px", padding: "16px" },
  kanbanColumnHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", paddingBottom: "12px", borderBottom: "2px solid #E5E7EB" },
  kanbanColumnTitle: { margin: 0, fontSize: "14px", fontWeight: 700, color: "#374151" },
  kanbanCount: { background: "#E5E7EB", color: "#6B7280", borderRadius: "999px", padding: "4px 10px", fontSize: "12px", fontWeight: 600 },
  kanbanCards: { display: "flex", flexDirection: "column", gap: "12px" },
  kanbanCard: { background: "#fff", border: "1px solid #E5E5EA", borderRadius: "12px", padding: "14px" },
  ...
  kanbanCardMeta: { margin: "0 0 8px", color: "#6B7280", fontSize: "12px" },
  kanbanCardText: { margin: 0, color: "#374151", fontSize: "13px", lineHeight: 1.5 },
  ...
  kanbanEmpty: { color: "#9CA3AF", fontSize: "13px", textAlign: "center", padding: "20px 0" },
};
