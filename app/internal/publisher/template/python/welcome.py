...
class WelcomeDialog:
    def __init__(self, client: ApiClient, product_name: Optional[str] = None,
        ...
        self._primary = colors.get('primary', self.branding.get('primary_color', '#6366f1'))
        self._secondary = colors.get('secondary', self.branding.get('secondary_color', '#4f46e5'))
        self._bg = colors.get('bg_page', '#f0f2f5')
        self._card_bg = colors.get('bg_card', '#ffffff')
        self._text_primary = colors.get('text_primary', '#1a1a2e')
        self._text_secondary = colors.get('text_secondary', '#6b7280')
        self._success = colors.get('success', '#10b981')
        self._error = colors.get('error', '#ef4444')
        self._border = colors.get('border', '#d1d5db')
        # Feature flags
    ...
    def _build_ui(self):
        ...
        labels = self.branding.get('labels', {})
        self._send_btn = tk.Button(frame, text=labels.get('send_otp_btn', 'Send OTP'), font=('Helvetica', 12, 'bold'),
        ...
        self._verify_btn = tk.Button(otp_frame, text=labels.get('verify_otp_btn', 'Verify'), font=('Helvetica', 12, 'bold'),
        ...
        company = self.branding.get('company_name', '') or self.product_name or '${product_name}'
