...
version = "${kitVersion}"
edition = "2021"
description = "${productName} SDK — License management client with HMAC-SHA256 signing, hardware fingerprinting, offline cache, and trial/license lifecycle support"
license = "MIT"
authors = ["Websmith License API Center"]
...
`,
    'README.md': `# ${productName} SDK (Rust)
...
\`\`\`rust
use ${libName}::{load_config, LicenseEngine};
